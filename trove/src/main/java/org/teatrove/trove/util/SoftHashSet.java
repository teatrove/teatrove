...
/**
 * A Set that softly references its elements and can be used as a simple cache.
 * SoftHashSet is not thread-safe and must be wrapped with
 ...
 */
public class SoftHashSet extends AbstractSet implements Set, Cloneable {
    /**
     * Test program.
     */
    /*
    ...
    */
    ...
    public Object clone() {
        try {
            SoftHashSet t = (SoftHashSet)super.clone();
    ...
    private class SetIterator implements Iterator {
        private Entry[] mTable = SoftHashSet.this.mTable;
    ...
    /**
     * This allows null references to be saved into SoftHashSet and allow
