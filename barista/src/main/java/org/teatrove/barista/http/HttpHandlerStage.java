...
/**
 * HttpHandlerStage is similar to a servlet filter, except it is specific to
 * {@link HttpHandler}. One key difference is that a handler stage may take
 * over the connection and process it asynchronously.
 *
 * @author Brian S O'Neill
 */
public interface HttpHandlerStage {
    /**
    ...
    public interface Chain {
         ...
         * @return true if caller should not close connection
         */
        public boolean doNextStage(HttpServerConnection con) throws Exception;
    }
